...
5. Navigation, footer, cookie, social, newsletter, and duplicate Markdown lines are removed before OpenAI analysis.
6. OpenAI returns a structured GEO report with citation gaps, recommendations, AI answer targets, and technical/content signals.
